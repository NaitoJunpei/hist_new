...
function Main() {
  ...
  document.getElementById("time").innerHTML = "<font size='2pt' face='Arial'>Computation time: (A) : " + (time_old[2]-time_old[1]) + " ms; (B)-(A) : " + (time_old[3]-time_old[2]) + " ms; (C) : " + (time_old[4]-time_old[3]) + " ms; (D)-(C) : " + (time_old[5]-time_old[4]) + " ms; (E) : " + (time_old[6]-time_old[5]) + " ms; (F) : " + (time_old[7]-time_old[6]) + " ms</font>";

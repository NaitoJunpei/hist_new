function [y,t,optw,W,C,confb95,yb] = sskernel_ref_rate_v1(x,tin,W)
% [y,t,optw,W,C,confb95,yb] = sskernel_ref_rate(x,t,W)
%
...
addright = fftkernel(horzcat(y_hist(halflen+1:length(y_hist)),zeros(1,remlen)),w/dt);

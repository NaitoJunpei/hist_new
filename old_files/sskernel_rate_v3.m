function [y,t,optw,W,C,confb95,yb] = sskernel_rate_v3(x,tin,W)
% [y,t,optw,W,C,confb95,yb] = sskernel_rate_v3(x,t,W)
%
% Function `sskernel_rate_v3' returns an optimized kernel density estimate

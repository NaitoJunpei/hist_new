##########
# SS_v3.py computes the optimal number of bins of time-histogram based on the optimization method proposed by Shimazaki and Shinomoto 2007.
# needs libraries: (matplotlib, numpy).

# Instruction
# put SS_v3.py in a folder.
# import SS_v3
# then you may obtain SS_v3.().

function [y,t,optw,W,C,confb95,yb] = sskernel_ref_rate_v4(x,tin,W)
% [y,t,optw,W,C,confb95,yb] = sskernel_ref_rate_v4(x,t,W)
%
% Function `sskernel_ref_rate_v4' returns an optimized kernel density estimate
...
% 190225 Add sorting part by Kazuki Nakamura
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Parameters Settings
...
if nargin == 1
    T = max(x) - min(x);
    [mbuf,nbuf,dt_samp] = find( sort(diff(x)),1,'first');

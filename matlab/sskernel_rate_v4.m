function [y,t,optw,W,C,confb95,yb] = sskernel_rate_v4(x,tin,W)
% [y,t,optw,W,C,confb95,yb] = sskernel_rate_v4(x,t,W)
%
% Function `sskernel_rate_v4' returns an optimized kernel density estimate
% using a Gauss kernel function.
%
% Examples:
% >> x = 0.5-0.5*log(rand(1,1e3)); t = linspace(0,3,1000);
% >> [y,t,optw] = sskernel_rate_v3(x,t);
...
%
% >> [y,t,optw,confb95,yb] = sskernel_rate_v3(x);
...
%
% 190225 Add sorting by Kazuki Nakamura
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Parameters Settings
